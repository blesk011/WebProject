...
/**
 * Servlet implementation class MngrAppointStaffAction
 */
@WebServlet("/MngrAppointStaffAction")
public class MngrAppointStaffAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UserDBBean.getinstance().appointStaff(user_id);
